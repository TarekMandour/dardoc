...
@section('breadcrumb')
    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0"> الاقسـام </h1>
@endsection
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <!--begin::Form-->
                <form id="kt_account_profile_details_form" action="{{route('roles.update_permission', $role->id)}}" class="form"
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-n2">
                            <!--begin:::Tab item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#arabic">تعديل الصلاحية</a>
                            </li>
                            <!--end:::Tab item-->
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-check form-switch form-check-custom form-check-solid">
                                                                            <input class="form-check-input" type="checkbox" value="{{$single->name}}" id="switch{{$k}}{{$key}}" switch="purple" name="permissions[]" @if(in_array($single->id, $r_permissions))checked @endif/>
