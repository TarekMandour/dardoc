...
@section('breadcrumb')
    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">الحالات الادارية</h1>
@endsection
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                <!--begin::Form-->
                                <form id="" class="form" method="post" action="{{url('admin/store-vacation')}}" enctype="multipart/form-data">
                                @csrf
                                <!--begin::Scroll-->
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="name"
                                                ...
                                                placeholder="العنوان" value="{{old('name')}}" required/>
                                            <!--end::Input-->
                                        </div>
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#data_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('vacation.datatable.data') }}',
                    data: {}
                },
                columns: [
            ...
            $.ajax({
                url: "{{ URL::to('admin/add-vacation-button')}}",
