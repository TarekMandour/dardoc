...
@section('breadcrumb')
    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">تقرير الاجازات </h1>
@endsection
                                    ...
                                    <div class="card-body pt-0">
                                        <table class="table align-middle table-row-dashed fs-4 gy-5"
                                            ...
                                            <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-125px">عدد الاجازات</th>
            ...
            if(check_cards == false){
                $(function () {
                    var table = $('#data_table_status').DataTable({
                        ...
                        ajax: {
                            url: '{{ route('vacation_em.datatable.data')}}',
            ...
            if (check_debits == false){
                $(function () {
                    var table = $('#data_table_vacation').DataTable({
                        ...
                        ajax: {
                            url: '{{ route('vacation_ca.datatable.data')}}',
