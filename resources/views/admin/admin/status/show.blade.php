        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card mb-10 g-5">
                <!--begin::Content-->
                        ...
                        <div id="kt_account_settings_profile_details" class="collapse show">
                            <!--begin::Form-->
                            <form id="kt_account_profile_details_form" action="{{url('admin/store-detail-status')}}" class="form"
                            ...
                            <!--begin::Card body-->
                                ...
                                <!--end::Scroll-->
                                <!--begin::Actions-->
                                <input type="hidden" name="admin_status_id" value="{{$data->id}}" />
            ...
            <div class="card mb-5 g-5 g-xl-8">
                ...
                <div class="card-body pt-3">
                    @foreach ($data->statusdetails as $item)
                        <!--begin::Item-->
                    <div class="d-flex align-items-sm-center mb-7">
                        ...
                        <div class="d-flex flex-row-fluid align-items-center flex-wrap my-lg-0 me-2">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="{{url("admin/delete-status-detail/" . $item->id)}}" class="btn btn-icon btn-danger btn-sm border-0">
