    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="" class="form" method="post" action="{{url('admin/store-admin-status')}}" enctype="multipart/form-data">
                @csrf
                <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7"
                        ...
                        <div class="mb-10 fv-row">
                            <!--begin::Label-->
                            <label class="required form-label">الحالات الادارية </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select class="form-control form-control-solid mb-3 mb-lg-0"
                                    name="status_id" aria-label=""  id="state">
                                <option value="">اختر من الحالات</option>
                                @foreach(\App\Models\Status::get() as $state)
        ...
        if (dataList.length > 0) {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: '{{url("admin/delete-admin-status")}}',
                        type: "get",
