<div class="dt-buttons flex-wrap">
    ...
    <!--end::Filter-->
    <!--begin::Add user-->
    <a href="{{url('admin/create-post-image/'.$data->id)}}" class="btn btn-light-primary me-3">
    ...
    <a href="{{url('admin/post')}}" class="btn btn-light-primary me-3">
        رجوع
    </a>
</div>
        ...
        if (dataList.length > 0) {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: '{{url("admin/delete-post-image")}}',
                        type: "get",
