...
{{--    </a>--}}
    ...
    <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal"
            data-bs-target="#kt_modal_add_debit">
        <i class="bi bi-plus-circle-fill fs-2x"></i>
    </button>
...
<div class="modal fade" id="kt_modal_add_debit" tabindex="-3" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="" class="form" method="post" action="{{url('admin/store-client-payment')}}" enctype="multipart/form-data">
                @csrf
                <!--begin::Scroll-->
        ...
        if (dataList.length > 0) {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: '{{url("admin/delete-client-payment")}}',
                        type: "get",
