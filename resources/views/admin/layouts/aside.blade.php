        ...
        <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu-item pt-5">
                ...
                <div class="menu-content">
                    <span class="menu-heading text-muted fw-bold text-uppercase fs-7">Activities</span>
                </div>
                <!--end:Menu content-->
            </div>
            ...
            <div
                ...
                id="#kt_aside_menu" data-kt-menu="true">
                <div class="menu-item">
                    <a class="menu-link" href="{{url('admin/record')}}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-muted svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none">
            ...
            <div
                ...
                id="#kt_aside_menu" data-kt-menu="true">
                <div class="menu-item">
                    <a class="menu-link" href="{{url('admin/report-medicine')}}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-muted svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none">
            ...
            <div class="menu-item pt-5">
                <!--begin:Menu content-->
                <div class="menu-content">
                    <span class="menu-heading text-muted fw-bold text-uppercase fs-7">Settings management</span>
                </div>
                <!--end:Menu content-->
            </div>

            @can('الحالات الادارية')
            <div
                class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                id="#kt_aside_menu" data-kt-menu="true">
                <div class="menu-item">
                    <a class="menu-link" href="{{url('admin/medicine')}}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-muted svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none">
            ...
            <div class="menu-item pt-5">
                <!--begin:Menu content-->
                <div class="menu-content">
                    <span class="menu-heading text-muted fw-bold text-uppercase fs-7">Staff management</span>
                </div>
                <!--end:Menu content-->
            </div>
