                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="link" class="form-control mb-2" placeholder="لينك" value="{{$data->link}}" />
                                                                    <!--end::Input-->
                                                                </div>
                                                                <!--end::Input group-->
                                                            </div>
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                    ...
                                                                    <div class="col-lg-8">
                                                                        ...
                                                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{asset('public/admin')}}/assets/media/svg/avatars/blank.svg')">
                                                                            ...
                                                                            <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{asset('public/admin')}}/assets/media/avatars/blank.png)"></div>
                                                                            @else  
                                                                                <img class="img-thumbnail" id="get_photo_link" style="width: 200px;" src="{{$data->background}}" data-holder-rendered="true">
                                                                            @endif
