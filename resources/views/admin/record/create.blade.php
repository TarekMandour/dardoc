    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
                ...
                <!--begin::Content-->
                            ...
                            <!--begin::Form-->
                            <form id="kt_account_profile_details_form" action="{{url('admin/store-record')}}" class="form"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="patient_name" class="form-control mb-2" placeholder="Patient name" value="" />
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="husband_name" class="form-control mb-2" placeholder="Husband name" value="" />
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="referral_dr" class="form-control mb-2" placeholder="Referral dr" value="" />
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="number" name="patient_age" class="form-control mb-2" placeholder="Patient age" value="" />
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="number" name="husband_age" class="form-control mb-2" placeholder="Husband age" value="" />
                                                                    <!--end::Input-->
                                                                </div>
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="date" name="retrieval_date" class="form-control mb-2" placeholder="Retrieval date" value="" />
                                                                    <!--end::Input-->
                                                                </div>

                                                                <div class="mb-5 fv-row">
                                                                    <div class="form-check form-check-custom form-check-solid form-check-sm">
                                                                        <input class="form-check-input" type="radio" value="1" name="sex" id="flexRadioLg"/>
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    <div class="form-check form-check-custom form-check-solid form-check-sm">
                                                                        <input class="form-check-input" type="radio" value="2" name="sex" id="flexRadioLg2"/>
                                                                ...
                                                                <table class="table align-middle table-row-dashed gy-5">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <input type="text" name="number_fsh" class="form-control" value="" />
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <input type="text" name="number_hmg" class="form-control" value="" />
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <input type="text" name="number_triggering" class="form-control" value="" />
                                                                            
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" name="number_e2" class="form-control" value="" />
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" name="number_p4" class="form-control" value="" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Number</td>
                                                                        <td>
                                                                            ...
                                                                            <input type="text" name="number_fsh2" class="form-control" value="" />
                                                                        </td>
                                                                        <td>
                                                                            <select class="form-control form-control-solid"
                                                                            ...
                                                                            <input type="text" name="number_hmg2" class="form-control" value="" />
                                                                        </td>
                                                                        <td>
                                                                            <select class="form-control form-control-solid"
                                                                            ...
                                                                            <input type="text" name="number_triggering2" class="form-control" value="" />
                                                                        </td>
                                                                        <td>
                                                            ...
                                                            <div class="col-12">
                                                                <table class="table align-middle table-row-dashed gy-5">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <input type="text" name="motility" class="form-control" value="" />
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" name="progressive_motility" class="form-control" value="" />
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" name="abnormality" class="form-control" value="" />
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="oocyte_no" class="form-control mb-2" placeholder="Oocyte no" value="" />
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="total_injected" class="form-control mb-2" placeholder="Total injected" value="" />
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="m2" class="form-control mb-2" placeholder="M2" value="" />
                                                                    <!--end::Input-->
                                                                </div>
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <textarea name="oocytes_comment" class="form-control mb-2"></textarea>
                                                                    <!--end::Input-->
                                                                </div>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="m1" class="form-control mb-2" placeholder="M1" value="" />
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="gv" class="form-control mb-2" placeholder="GV" value="" />
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="m2_abn" class="form-control mb-2" placeholder="M2 abn " value="" />
                                                                    <!--end::Input-->
                                                                </div>
                                                                <!--end::Input group-->
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <table class="table align-middle table-row-dashed gy-5">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <input type="text" name="embryos" class="form-control" value="" />
                                                                        </td>
                                                                        <td>
                                                                            <input type="date" name="date" class="form-control" value="" />
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" name="straws" class="form-control" value="" />
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </div>
