...
class VacationController extends Controller
{
    ...
    public function datatable(Request $request)
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('actions', function ($row) {
                $actions = ' <a href="' . url("admin/edit-vacation/" . $row->id) . '" class="btn btn-light-info"><i class="bi bi-pencil-fill"></i> تعديل </a>';
                return $actions;
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/vacation')->with('message', 'تم الاضافة بنجاح')->with('status', 'success');
    }
...
//    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('admin/vacation')->with('message', 'تم التعديل بنجاح')->with('status', 'success');
    }
